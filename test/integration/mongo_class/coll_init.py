...
"""Program:  coll_init.py
    ...
    Description:  Integration testing of Coll.__init__ in mongo_class.py.
...
class UnitTest(unittest.TestCase):
    ...
    Methods:
        ...
        test_config_attr2
        test_coll_attr
        test_default_coll_coll
        test_using_coll_coll
        test_default_coll_db
        test_using_coll_db
    ...
    def test_ssl_all_phrase2(self):
        ...
        mongo = mongo_class.Coll(
            ...
            ssl_client_phrase=self.ssl_client_phrase, coll=self.coll_name)
    ...
    def test_ssl_client_key_cert3(self):
        ...
        mongo = mongo_class.Coll(
            ...
            port=self.cfg.port, conf_file=self.conf_file,
            ssl_client_key=self.ssl_client_key,
            ssl_client_cert=self.ssl_client_cert, coll=self.coll_name)
    ...
    def test_ssl_client_ca6(self):
        ...
        mongo = mongo_class.Coll(
            ...
            port=self.cfg.port, conf_file=self.conf_file,
            ssl_client_ca=self.ssl_client_ca,
            ssl_client_key=self.ssl_client_key, coll=self.coll_name)
    ...
    def test_default_coll_coll(self):
        ...
        """Function:  test_default_coll_coll

        Description:  Test using the default coll_coll attribute.
    ...
    def test_using_coll_coll(self):

        """Function:  test_using_coll_coll

        Description:  Test using the coll_coll attribute.
        ...
        self.assertEqual(mongo.coll_coll, self.coll_name)

    def test_default_coll_db(self):

        """Function:  test_default_coll_db

        Description:  Test using the default coll_db attribute.
    ...
    def test_using_coll_db(self):

        """Function:  test_using_coll_db

        Description:  Test using the coll_db attribute.
        ...
        mongo = mongo_class.Coll(
            self.cfg.name, self.cfg.user, self.cfg.japd, host=self.cfg.host,
            port=self.cfg.port, db=self.coll_db)
    ...
    def test_conn_list_attr(self):
        ...
        mongo = mongo_class.Coll(self.cfg.name, self.cfg.user, self.cfg.japd,
