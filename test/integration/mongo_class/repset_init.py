...
"""Program:  repset_init.py
    ...
    Description:  Integration testing of RepSet.__init__ in mongo_class.py.
...
class UnitTest(unittest.TestCase):
    ...
    Methods:
        ...
        test_repset_hosts_attr2 -> Test repset_hosts attribute.
        test_repset_hosts_attr -> Test repset_hosts attribute.
    ...
    def test_repset_hosts_attr(self):
        ...
        self.assertEqual(mongo.repset_hosts, self.cfg.repset_hosts)

    def test_repset_attr2(self):
        ...
        mongo = mongo_class.RepSet(
            self.cfg.name, self.cfg.user, self.cfg.japd, host=self.cfg.host,
            port=self.cfg.port, repset=None)
