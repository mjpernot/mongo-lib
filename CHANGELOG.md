...
### Changed
- mongo_class.RepSetColl.\_\_init\_\_:  Added capability to allow SSL attributes to be set.
- mongo_class.RepSet.\_\_init\_\_:  Added capability to allow SSL attributes to be set.
...
- mongo_class.DB.\_\_init\_\_:  Added capability to allow SSL attributes to be set.
